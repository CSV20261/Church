-- =====================================================
-- FINALIZE CORE DATA AND HIERARCHY (CORRECTED)
-- Update names, titles, and constraints
-- Fixed table name: overseererships (not overseerships)
-- =====================================================
...
ALTER TABLE public.members
DROP CONSTRAINT IF EXISTS underdeacon_must_be_male;
