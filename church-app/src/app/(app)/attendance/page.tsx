  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 lg:p-8 max-w-7xl mx-auto w-full overflow-x-hidden">
      ...
      <div className="mb-6">
        ...
        <p className="text-neutral-600">Record and track attendance for church events</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-4">
            <h2 className="font-semibold text-neutral-900 mb-4">Select Event</h2>
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {events.length === 0 ? (
                <p className="text-neutral-500 text-sm">No events found. Create an event first.</p>
              ) : (
                events.map((event) => (
                  <button
                    key={event.id}
                  ...
                  >
                    ...
                    <p className="text-xs text-neutral-500 mt-1">{formatDate(event.date_time)}</p>
                  </button>
                ))
              )}
            </div>
        ...
        <div className="lg:col-span-3">
          {!selectedEvent ? (
            <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-neutral-900 mb-2">Select an Event</h3>
              <p className="text-neutral-500">Choose an event from the sidebar to record attendance</p>
            </div>
          ) : (
            <>
              {/* Event Info & Stats */}
              <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-4 mb-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div>
                    <h2 className="text-lg font-semibold text-neutral-900">{selectedEvent.title}</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-4">
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full pl-4 pr-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  />
                </div>
                          ...
                          <tr key={member.id} className="hover:bg-neutral-50">
                            ...
                            <td className="px-6 py-4 text-center">
                              {status ? (
                                ...
                                <span className="text-neutral-400 text-sm">Not recorded</span>
                              )}
                            </td>
                            {userProfile && canRecordAttendance(userProfile.role) && (
                              <td className="px-6 py-4">
